 ...
 */
function login() {
    return location.href = "http://sso.vcgo.com/user/showLogin";
}
function regist() {
    return location.href = "http://sso.vcgo.com/user/showRegister";
}
...
function search(a) {
    var b = "http://search.vcgo.com/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
